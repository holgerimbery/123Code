...
| [Remote Repositories](https://marketplace.visualstudio.com/items?itemName=GitHub.remotehub-insiders) -Remotely browse and edit a GitHub repository (preview) <br /><br /> | <ol>Lets you quickly browse, search, edit, and commit to any GitHub repository directly from within VS Code.</ol> |
